...
public class Aves {
    ...
    public Aves(String fechadeobservacion, String latitud, String longitud, String especie, String profundidad, String abundancia, String sizefish, String selechabitat) {
        this.fecha=getFecha();
