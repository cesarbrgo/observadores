...
/**
 * PecesMediterraneos
 * La clase PecesMediterraneos  es un objeto que puede ser avistado por un usuario, lo ideal seria instanciar este objeto a traves de la selección del usuario
 ...
 */
public class PecesMediterraneos {
    private String fecha, latitud, longitud, especie, profundidad, abundancia, size, habitat;

    public PecesMediterraneos(String fechadeobservacion, String latitud, String longitud, String especie, String profundidad, String abundancia, String sizefish, String selechabitat) {
        this.fecha=getFecha();
